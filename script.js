const apiKey = "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";

const maxImages = 4; //Number of images generate for each prompt
let selectedImageNumber = null;

//Function to generate a random numberbetween min and max (inclusive)
...
document.addEventListener("keypress", (event)=> {
    if (event.key === 'Enter') { // key code of the keybord key
        ...
        if(document.getElementById("user-prompt").value.trim() === ''){
            return;
        }else{
